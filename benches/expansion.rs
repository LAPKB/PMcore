...
fn benchmark_adaptive_grid(c: &mut Criterion) {
    c.bench_function("adaptive_grid_small", |b| {
        let mut theta = Array2::from_elem((100, 2), 0.5); // Small grid example
        let eps = 0.1;
    ...
    c.bench_function("adaptive_grid_large", |b| {
        ...
        let eps = 0.1;
        let ranges = vec![(0.0, 1.0), (0.0, 100.0), (0.0, 100.0), (0.0, 100.0), (0.0, 100.0), (0.0, 100.0), (0.0, 100.0), (0.0, 100.0), (0.0, 100.0), (0.0, 100.0)];
        let min_dist = 0.01;
