...
pub(crate) fn main() {
    ...
    let params = Parameters::builder()
        ...
        .add("ske", 0.0, 0.06046061, false) // range from ode w/sobol prior
        .add("svol",0.0, 9.49601745,false)
        .build()
        .unwrap();
    ...
    settings.set_output_path("examples/vanco_sde_004/output_sde_0pt2_of_mean_ode"); // *** SET OUTPUT DIRECTORY HERE ***
    //
