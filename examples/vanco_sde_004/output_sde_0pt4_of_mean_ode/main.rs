...
pub(crate) fn main() {
    ...
    let params = Parameters::builder()
        ...
        .add("ske", 0.0, 0.12092123, false) // range from ode w/sobol prior
        .add("svol",0.0, 18.99203489,false)
        .build()
        .unwrap();
    ...
    settings.set_output_path("examples/vanco_sde_004/output_sde_0pt4_of_mean_ode"); // *** SET OUTPUT DIRECTORY HERE ***
    //
