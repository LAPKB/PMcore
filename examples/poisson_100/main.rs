...
fn main() -> Result<()> {
    ...
    let params = Parameters::new()
        .add("ec50", 1.762668, 2.138798)
        .add("Kk", 1.540277, 1.772984)
        .add("Kg", 2.227923, 2.901866)
        .add("Kknat", 0.9137731, 1.4066447);

    let em = ErrorModel::proportional(ErrorPoly::new(0.01, 0.0025, 0.0, 0.0), 12.718282, None);
    ...
    settings.set_output_path(
        "/Users/wyamada/Documents/CHLA/poisson_paper/data/RustTesting_100/rust_output/",
    );
    ...
    let data = data::read_pmetrics(
        "/Users/wyamada/Documents/CHLA/poisson_paper/data/RustTesting_100/rust_input/d18.csv",
    )?;
